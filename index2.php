    ...
    if($result)
    {
        $rows = mysqli_num_rows($result); // количество полученных строк
         ...
         <tr><th> ФИО </a>
            ...
            <input type='submit' style='height:35px; width:250px' value='Добавить новую запись'> &nbsp
            </form>";

            echo "<form method='post' action='search.php?go'>
            <input type='text' style='height:27px; width:250px' name='query' placeholder='Поиск'>
            <input type='submit' name='submit' value='Найти' style='height:35px; width:100px'> &emsp; 
            </form>";

            echo "Ваш логин: <strong>".$_SESSION['login']."</strong>&emsp; ";

            echo "<form method='post' action='index.php'>
            <input type='submit' name='submit2' style='height:30px; width:100px' value='Выход'>
            </form><br><br>";
